...
CREATE TABLE IF NOT EXISTS `daw1703`.`Games` (
  ...
  `games_url_image` VARCHAR(200) NOT NULL,
...
INSERT INTO Games_libraries (Libraries_libraries_id_library,Games_games_id_game) VALUES (gameId,userId);
