...
-- Schema daw1703
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `daw1703` DEFAULT CHARACTER SET utf8 ;
USE `daw1703` ;

-- -----------------------------------------------------
-- Table `daw1703`.`Countries`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Countries` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Countries` (
...
-- -----------------------------------------------------
-- Table `daw1703`.`Provinces`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Provinces` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Provinces` (
  ...
  CONSTRAINT `fk_Provinces_Countries1`
    ...
    REFERENCES `daw1703`.`Countries` (`countries_id_country`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `daw1703`.`Users` (
  ...
  CONSTRAINT `fk_Users_Provinces1`
    ...
    REFERENCES `daw1703`.`Provinces` (`provinces_id_province`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `daw1703`.`Genders`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Genders` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Genders` (
...
-- Table `daw1703`.`Games`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Games` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Games` (
  `games_id_game` INT NOT NULL AUTO_INCREMENT,
  `games_name` VARCHAR(200) NOT NULL,
  `games_description` VARCHAR(250) NOT NULL,
  `games_price` DOUBLE NOT NULL,
  `games_publication_date` DATE NOT NULL,
  `games_url_image` VARCHAR(250) NOT NULL,
  ...
  CONSTRAINT `fk_Games_Genders1`
    ...
    REFERENCES `daw1703`.`Genders` (`genders_id_gender`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- Table `daw1703`.`Bills`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Bills` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Bills` (
  `bills_id_bill` INT NOT NULL AUTO_INCREMENT,
  `bills_price` DOUBLE NOT NULL,
  `bills_date` TIMESTAMP NOT NULL,
  ...
  CONSTRAINT `fk_Bills_Users1`
    ...
    REFERENCES `daw1703`.`Users` (`users_id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `daw1703`.`Bill_Details`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Bill_Details` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Bill_Details` (
  `Bill_Details_counter` INT NOT NULL AUTO_INCREMENT,
  `Bills_bills_id_bill` INT NOT NULL,
  `Games_games_id_game` INT NOT NULL,
  `bill_details_quantity` INT NULL,
  ...
  CONSTRAINT `fk_Bill_Details_Bills1`
    ...
    REFERENCES `daw1703`.`Bills` (`bills_id_bill`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `daw1703`.`Forums`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Forums` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Forums` (
...
-- -----------------------------------------------------
-- Table `daw1703`.`Topics`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Topics` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Topics` (
  ...
  CONSTRAINT `fk_Topics_Forums1`
    ...
    REFERENCES `daw1703`.`Forums` (`forums_id_forum`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `daw1703`.`Replies`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Replies` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Replies` (
  ...
  CONSTRAINT `fk_Replies_Topics1`
    ...
    REFERENCES `daw1703`.`Topics` (`topics_id_topic` , `Forums_forums_id_forum`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `daw1703`.`Libraries`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Libraries` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Libraries` (
...
-- -----------------------------------------------------
-- Table `daw1703`.`Friends`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Friends` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Friends` (
  `Users_users_id_user` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `daw1703`.`Reviews`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Reviews` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Reviews` (
...
-- Table `daw1703`.`Chats`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Chats` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Chats` (
  `chats_id_chat` INT NOT NULL AUTO_INCREMENT,
  `chats_text` VARCHAR(10000) NOT NULL,
  `chats_datetime` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `daw1703`.`Friendship_Solicitations`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Friendship_Solicitations` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Friendship_Solicitations` (
...
-- Table `daw1703`.`Walls`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Walls` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Walls` (
...
-- -----------------------------------------------------
-- Table `daw1703`.`Messages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Messages` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Messages` (
  ...
  CONSTRAINT `fk_Messages_Walls1`
    ...
    REFERENCES `daw1703`.`Walls` (`walls_id_wall`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `daw1703`.`Game_Requirements`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `daw1703`.`Game_Requirements` ;

CREATE TABLE IF NOT EXISTS `daw1703`.`Game_Requirements` (
  `Games_games_id_game` INT NOT NULL,
  `games_requirements_os_min` VARCHAR(200) NOT NULL,
  `games_requirements_processor_min` VARCHAR(100) NOT NULL,
  `games_requirements_memory_min` VARCHAR(8) NOT NULL,
  `games_requirements_hd_min` VARCHAR(10) NOT NULL,
  `games_requirements_video_card_min` VARCHAR(200) NOT NULL,
  `games_requirements_directx_min` VARCHAR(50) NOT NULL,
  `games_requirements_os_rec` VARCHAR(200) NOT NULL,
  `games_requirements_processor_rec` VARCHAR(100) NOT NULL,
  `games_requirements_memory_rec` VARCHAR(8) NOT NULL,
  `games_requirements_hd_rec` VARCHAR(10) NOT NULL,
  `games_requirements_video_card_rec` VARCHAR(200) NOT NULL,
  `games_requirements_directx_rec` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`Games_games_id_game`),
  CONSTRAINT `fk_Game_Requirements_Games1`
    FOREIGN KEY (`Games_games_id_game`)
    REFERENCES `daw1703`.`Games` (`games_id_game`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
USE `daw1703`$$
DROP TRIGGER IF EXISTS `daw1703`.`Users_AFTER_INSERT` $$
USE `daw1703`$$
CREATE DEFINER = CURRENT_USER TRIGGER `daw1703`.`Users_AFTER_INSERT` AFTER INSERT ON `Users` FOR EACH ROW
...
USE `daw1703`$$
DROP TRIGGER IF EXISTS `daw1703`.`Games_AFTER_INSERT` $$
USE `daw1703`$$
CREATE DEFINER = CURRENT_USER TRIGGER `daw1703`.`Games_AFTER_INSERT` AFTER INSERT ON `Games` FOR EACH ROW
...
USE `daw1703`$$
DROP TRIGGER IF EXISTS `daw1703`.`Bill_Details_AFTER_INSERT` $$
USE `daw1703`$$
CREATE DEFINER = CURRENT_USER TRIGGER `daw1703`.`Bill_Details_AFTER_INSERT` AFTER INSERT ON `Bill_Details` FOR EACH ROW
BEGIN
DECLARE gameId int;
...
USE `daw1703`$$
DROP TRIGGER IF EXISTS `daw1703`.`Reviews_AFTER_INSERT` $$
USE `daw1703`$$
CREATE DEFINER = CURRENT_USER TRIGGER `daw1703`.`Reviews_AFTER_INSERT` AFTER INSERT ON `Reviews` FOR EACH ROW
BEGIN
DECLARE gameId int;
...
USE `daw1703`$$
DROP TRIGGER IF EXISTS `daw1703`.`Friendship_Solicitations_AFTER_UPDATE` $$
USE `daw1703`$$
CREATE DEFINER = CURRENT_USER TRIGGER `daw1703`.`Friendship_Solicitations_AFTER_UPDATE` AFTER UPDATE ON `Friendship_Solicitations` FOR EACH ROW
BEGIN
