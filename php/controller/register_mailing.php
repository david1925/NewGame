...
$iduser=$_GET['id'];
//Se recoge el nombre de usuario del usuario al que se le enviará el correo
...
$mail->AddAddress('david.gargom.94@gmail.com', 'David');
//Definimos el tema del email
$mail->Subject = 'Confirmation email';
//Para enviar un correo formateado en HTML lo cargamos con la siguiente función. Si no, puedes meterle directamente una cadena de texto.
$mail->MsgHTML("<p><h1>Welcome ".$username."</h1>
			To confirm your account for user: ".$username." please click on the next link: http://www.newgame.local/php/controller/user_confirmation.php?id=".$iduser."</p>");
